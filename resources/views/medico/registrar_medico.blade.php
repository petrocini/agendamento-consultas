    ...
    <form @if($edit ?? '') action="{{ route('editarMedicoAction', ['id' => $medico->id]) }}" @else action="{{ route('registrarMedicoAction') }}" @endif method="post">
        ...
        <div class="register_inputs">
            <div class="form-group">
                ...
                <input type="text" name="name" clasas="form-control" @if($edit ?? '') value="{{ $medico->name}}"@endif required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" minlength="6" maxlength="6" name="crm" class="form-control" value="" min="0" max="999999" required>
